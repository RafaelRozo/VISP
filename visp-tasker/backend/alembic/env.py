...
Note: The project's primary migration strategy uses raw SQL files in the
``migrations/`` directory (executed via ``scripts/migrate.py``). Alembic is
configured here as a secondary tool for auto-generating new migrations from
