 ...
 *   - Route line between provider and customer (Mapbox Directions API)
...
function JobTrackingScreen(): React.JSX.Element {
  ...
  // Route GeoJSON for Mapbox ShapeSource
...
const styles = StyleSheet.create({
  ...
  sectionTitle: { ...Typography.headline, color: '#FFFFFF', marginBottom: Spacing.lg },
  providerHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: Spacing.lg },
  avatar: { width: 60, height: 60, borderRadius: 30, backgroundColor: 'rgba(120, 80, 255, 0.25)', alignItems: 'center', justifyContent: 'center', marginRight: Spacing.lg, borderWidth: 2, borderColor: 'rgba(120, 80, 255, 0.5)' },
  avatarText: { fontSize: FontSize.title3, fontWeight: FontWeight.bold as '700', color: '#FFFFFF' },
  providerInfo: { flex: 1 },
  ...
  mapCard: { borderRadius: BorderRadius.md, overflow: 'hidden', borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.15)', position: 'relative' },
  mapView: { height: 260, width: '100%' },
  customerMarker: { width: 24, height: 24, borderRadius: 12, backgroundColor: `${Colors.primary}30`, alignItems: 'center', justifyContent: 'center' },
  customerMarkerInner: { width: 12, height: 12, borderRadius: 6, backgroundColor: Colors.primary },
  providerMarker: { width: 36, height: 36, borderRadius: 18, backgroundColor: 'rgba(120, 80, 255, 0.9)', alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: 'rgba(255, 255, 255, 0.3)' },
  providerMarkerText: { fontSize: 16, fontWeight: FontWeight.bold as '700', color: '#FFFFFF' },
  etaOverlay: { position: 'absolute', top: Spacing.md, right: Spacing.md, backgroundColor: 'rgba(10, 10, 30, 0.7)', borderRadius: BorderRadius.sm, paddingHorizontal: Spacing.md, paddingVertical: Spacing.sm, borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.15)', alignItems: 'center' },
  etaOverlayLabel: { ...Typography.caption, color: 'rgba(255, 255, 255, 0.5)' },
  etaOverlayValue: { ...Typography.headline, color: Colors.primary, fontWeight: FontWeight.bold as '700' },
  searchingCard: { alignItems: 'center', justifyContent: 'center', minHeight: 200 },
  searchingTitle: { ...Typography.headline, color: '#FFFFFF', marginTop: Spacing.lg },
  searchingSubtext: { ...Typography.footnote, color: 'rgba(255, 255, 255, 0.5)', marginTop: Spacing.sm, textAlign: 'center' },
  arrivedBanner: { marginTop: Spacing.sm, alignItems: 'center', borderColor: 'rgba(39, 174, 96, 0.4)' },
  arrivedBannerText: { ...Typography.headline, color: Colors.success, textAlign: 'center' },
  timerCardBorder: { borderColor: 'rgba(120, 80, 255, 0.4)' },
  timerContent: { alignItems: 'center' },
  timerLabel: { ...Typography.label, color: 'rgba(120, 80, 255, 0.9)', marginBottom: Spacing.md },
  timerValue: { fontSize: 48, fontWeight: FontWeight.bold as '700', color: '#FFFFFF', fontVariant: ['tabular-nums'], marginBottom: Spacing.md },
  timerMeta: { flexDirection: 'row', alignItems: 'center', gap: Spacing.sm, marginBottom: Spacing.sm },
  timerMetaLabel: { ...Typography.footnote, color: 'rgba(255, 255, 255, 0.5)' },
  timerMetaValue: { ...Typography.headline, color: Colors.primary },
  timerNote: { ...Typography.caption, color: 'rgba(255, 255, 255, 0.3)', textAlign: 'center' },
  completedCardBorder: { borderColor: 'rgba(39, 174, 96, 0.4)' },
  completedContent: { alignItems: 'center' },
  completedTitle: { ...Typography.title3, color: Colors.success, marginBottom: Spacing.md },
  completedPrice: { fontSize: FontSize.title1, fontWeight: FontWeight.bold as '700', color: '#FFFFFF', marginBottom: Spacing.sm },
  completedSubtext: { ...Typography.footnote, color: 'rgba(255, 255, 255, 0.5)', textAlign: 'center', marginBottom: Spacing.xl },
  noProviderContent: { alignItems: 'center' },
  noProviderTitle: { ...Typography.title3, color: '#FFFFFF', marginBottom: Spacing.sm, textAlign: 'center' },
  noProviderText: { ...Typography.footnote, color: 'rgba(255, 255, 255, 0.5)', textAlign: 'center', lineHeight: 20, marginBottom: Spacing.lg },
  noProviderButtons: { width: '100%', gap: Spacing.sm },
  cancelJobBtnStyle: { borderColor: 'rgba(231, 76, 60, 0.5)' },
  timeline: { paddingLeft: Spacing.xs },
  timelineStep: { flexDirection: 'row', minHeight: 60 },
  timelineLeftCol: { alignItems: 'center', width: 24, marginRight: Spacing.md },
  timelineDot: { width: 16, height: 16, borderRadius: 8, alignItems: 'center', justifyContent: 'center' },
  timelineDotCurrent: { width: 20, height: 20, borderRadius: 10, borderWidth: 3, borderColor: 'rgba(120, 80, 255, 0.6)', backgroundColor: 'rgba(10, 10, 30, 0.8)' },
  timelineDotCheck: { fontSize: 10, color: '#FFFFFF', fontWeight: FontWeight.bold as '700' },
  timelineLine: { width: 2, flex: 1, marginVertical: Spacing.xxs },
  timelineContent: { flex: 1, paddingBottom: Spacing.lg },
  timelineLabel: { ...Typography.headline, color: '#FFFFFF', marginBottom: Spacing.xxs },
  timelineLabelCurrent: { color: 'rgba(120, 80, 255, 0.9)' },
  timelineLabelFuture: { color: 'rgba(255, 255, 255, 0.3)' },
  timelineDescription: { ...Typography.footnote, color: 'rgba(255, 255, 255, 0.5)' },
  timelineDescriptionFuture: { color: 'rgba(255, 255, 255, 0.25)' },
  noticeCardBorder: { borderColor: 'rgba(243, 156, 18, 0.25)' },
  noticeTitle: { ...Typography.headline, color: Colors.warning, marginBottom: Spacing.sm },
  noticeText: { ...Typography.footnote, color: 'rgba(255, 255, 255, 0.5)', lineHeight: 20 },
  bottomPadding: { height: Spacing.massive },
});
